...
function startTurn(){
    ...
    dummy.pos.x = game.camera.target.x + canvas.width/2 - dummy.sprite.scale.x;
    dummy.pos.y = game.camera.target.y + canvas.height/2 - dummy.sprite.scale.y;
    ...
    i.onKeyPressed("Enter", () => {
        ...
        i.onKeyPressed("Enter", ()=>{}); // clear the event
    })
...
function board_init(){
    ...
    game.input.onKeyPressed("space", () => {
            ...
            goto(playerNum, playersArr[playerNum].space, ()=>{
                ...
                moveBy(playerNum, r, ()=>{
                    ...
                    if(spaces[playersArr[playerNum].space].func != null){
                        spaces[playersArr[playerNum].space].func(playerNum, startTurn());
                    }else{
                        startTurn();
                    }
        ...
        // let moveBy = randInRange(1, 6); // Crowns helper function


        // playersArr[playerNum].space += 1;
